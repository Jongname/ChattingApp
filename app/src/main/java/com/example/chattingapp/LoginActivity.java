...
public class LoginActivity extends AppCompatActivity {
    ...
    private FirebaseAuth.AuthStateListener authStateListener;  //로그인 되었는지 확인하는
    private FirebaseRemoteConfig firebaseRemoteConfig; // 원격으로 버튼 색상 바꾸기위해
    ...
    void loginEvent(){    //로그인이 되었는지만 확인해주는
